...
export function EditCourseForm({
  ...
  const [selectedBrand, setSelectedBrand] = useState<string | undefined>(
    course.brand_id || undefined
  );
  const [selectedInstructor, setSelectedInstructor] = useState<
    string | undefined
  >(course.instructor_id || undefined);
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="space-y-2">
          ...
          <Input
            ...
            name="startDate"
            type="datetime-local"
            defaultValue={formatDateTimeLocal(course.start_date)}
            required
            disabled={loading}
          />
        </div>
        ...
        <div className="space-y-2">
          ...
          <Input
            ...
            name="endDate"
            type="datetime-local"
            defaultValue={formatDateTimeLocal(course.end_date)}
            required
            disabled={loading}
          />
        </div>
